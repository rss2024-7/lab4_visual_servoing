...
class ParkingController(Node):
    ...
    def relative_cone_callback(self, msg):
        ...
        if (self.relative_x < self.TURN_RADIUS and current_distance_error > 0) or (current_distance_error < 0 and current_angle > -1.57 and current_angle < 1.57):
        ...
        # car drives backwards (velocity < 0) in "backing" mode
            ...
            velocity = -K_p_drive*abs(current_distance_from_cone * 0.25) - K_d_drive*abs(current_distance_error - self.previous_distance_error)
